...
from lava_dispatcher.power import ResetDevice, RebootDevice
from lava_dispatcher.utils.constants import SHUTDOWN_MESSAGE
...
from lava_dispatcher.utils import vcs
...
class TestClasses(unittest.TestCase):
    ...
    def setUp(self):
        from lava_dispatcher.actions.deploy import strategies
        from lava_dispatcher.actions.boot import strategies
        from lava_dispatcher.actions.test import strategies
        self.allowed = [
